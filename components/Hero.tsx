      ...
      <div className="relative mx-auto flex max-w-6xl flex-col items-center gap-14 px-6 pb-24 pt-28 text-center md:flex-row md:text-left md:pt-32">
        <div className="flex-1 space-y-8">
          <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-5 py-2 text-sm text-slate-200/80 backdrop-blur">
            ...
            Cobertura inteligente en World Chain
          </div>
          <h1 className="text-5xl font-semibold leading-tight md:text-6xl">
            Seguro on-chain para humanos verificados.
          </h1>
          <p className="max-w-xl text-lg text-slate-300/90">
            Pólizas NFT, reclamos automatizados y pagos instantáneos impulsados por oráculos. Sin papeleo, sin fricción: solo
            protección transparente para comunidades de World ID.
          </p>
          <div className="flex flex-wrap items-center gap-4 text-sm text-slate-300/80">
            <span className="rounded-full bg-white/5 px-4 py-2">NFT Policies</span>
            <span className="rounded-full bg-white/5 px-4 py-2">Oráculos descentralizados</span>
            <span className="rounded-full bg-white/5 px-4 py-2">DAO Governance</span>
          </div>
        </div>
